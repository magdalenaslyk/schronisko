...
--
-- Host: 127.0.0.1
-- Czas generowania: 27 Lis 2019, 19:09
...
(6, 'Diana', 'Pies', 'Kundel', 'suka', '6 lat', 'do adopcji', 'Diana to bardzo grzeczna i ułożona sunia. Nienachalna, ale mocno kochająca człowieka. Pięknie chodzi na smyczy. Potrzebuje spokojnego opiekuna, która podaruje suni miłość i dobro, na jakie w pełni zasługuje.', '/img/animals_photo/dog6.jpg', NULL, NULL, NULL),
...
ALTER TABLE `adopcje`
  ...
  ADD UNIQUE KEY `id_uzytkownik` (`id_uzytkownik`);
...
ALTER TABLE `historia_platnosci`
  ...
  ADD UNIQUE KEY `id_adopcji` (`id_adopcji`);
